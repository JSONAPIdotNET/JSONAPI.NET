...
{
    /// <summary>
    /// Base class for the main payload builders
    /// </summary>
    public abstract class RegistryDrivenPayloadBuilder
    {
        private readonly IResourceTypeRegistry _resourceTypeRegistry;
        private readonly ILinkConventions _linkConventions;

        /// <summary>
        /// Creates a new RegistryDrivenPayloadBuilder
        /// </summary>
        /// <param name="resourceTypeRegistry"></param>
        /// <param name="linkConventions"></param>
        protected RegistryDrivenPayloadBuilder(IResourceTypeRegistry resourceTypeRegistry, ILinkConventions linkConventions)
        {
