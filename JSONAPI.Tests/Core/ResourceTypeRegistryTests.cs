...
namespace JSONAPI.Tests.Core
{
    ...
    public class ResourceTypeRegistryTests
    {
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_boolean_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));

            // Act
            registry.RegisterResourceType(typeof (AttributeGrabBag));
            var reg = registry.GetRegistrationForType(typeof (AttributeGrabBag));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_boolean_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_SByte_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_SByte_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Byte_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Byte_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Int16_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Int16_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_UInt16_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_UInt16_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Int32_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Int32_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_UInt32_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_UInt32_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Int64_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Int64_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_UInt64_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_UInt64_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Single_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Single_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Double_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Double_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_Decimal_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_Decimal_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_guid_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_guid_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_DateTime_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_DateTime_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_DateTimeOffset_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_DateTimeOffset_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_string_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_enum_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
        ...
        [TestMethod]
        public void RegisterResourceType_sets_up_correct_attribute_for_nullable_enum_field()
        {
            // Arrange
            var registry = new ResourceTypeRegistry(new DefaultNamingConventions(new PluralizationService()));
